              ...
              {COMM_STYLES.map(c => (
                <button
                  ...
                  style={{
                    ...
                    border:       prefs.communicationStyle === c.value ? '1.5px solid var(--color-pebble)' : '1px solid var(--border)',
                    borderRadius: 10,
                    padding:      '10px 14px',
                    cursor:       'pointer',
              ...
              {READING_LEVELS.map(r => (
                <button
                  ...
                  style={{
                    ...
                    border:       prefs.readingLevel === r.value ? '1.5px solid var(--color-pebble)' : '1px solid var(--border)',
                    borderRadius: 10,
                    padding:      '10px 14px',
                    cursor:       'pointer',
                    transition:   'all 0.2s ease',
              ...
              {GRANULARITIES.map(g => (
                <button
                  ...
                  style={{
                    ...
                    border:       prefs.granularity === g.value ? '1.5px solid var(--color-pebble)' : '1px solid var(--border)',
                    borderRadius: 10,
                    padding:      '10px 14px',
                    cursor:       'pointer',
                    transition:   'all 0.2s ease',
